...
utr_3 <- read.csv('~/Work/MuridRodentTroughs/dataAnalysis/dfe/3p_UTR.csv')
utr_3$elements <- "3' UTR"
utr_5 <- read.csv('~/Work/MuridRodentTroughs/dataAnalysis/dfe/5p_UTR.csv')
...
cneDFE<- read.csv('~/Work/MuridRodentTroughs/dataAnalysis/dfe/CNE.DFE.csv')
