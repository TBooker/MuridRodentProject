...
Mmc     <-read.csv('~/Work/MuridRodentTroughs/dataAnalysis/exons/Mmc.castaneusDistance.csv')
Mmc$lab <- 'M. m. castaneus'
Mmc$rat <- Mmc$pi/JC(Mmc$div2)
Mmc$pi_ref <- Mmc$rat/ mean( Mmc[ (abs(Mmc$dist) > 1500) & abs(Mmc$dist) < 2500  , ]$rat ) 


Mmdg<-read.csv('~/Work/MuridRodentTroughs/dataAnalysis/exons/Mmd_ger.castaneusDistance.csv')
...
Mmdf    <-read.csv('~/Work/MuridRodentTroughs/dataAnalysis/exons/Mmd_fra.castaneusDistance.csv')
...
Mmdi     <-read.csv('~/Work/MuridRodentTroughs/dataAnalysis/exons/Mmd_ira.castaneusDistance.csv')
...
Mmma     <-read.csv('~/Work/MuridRodentTroughs/dataAnalysis/exons/Mmm_afg.castaneusDistance.csv')
...
Mmmc     <-read.csv('~/Work/MuridRodentTroughs/dataAnalysis/exons/Mmm_cze.castaneusDistance.csv')
...
Mmmk     <-read.csv('~/Work/MuridRodentTroughs/dataAnalysis/exons/Mmm_kaz.castaneusDistance.csv')
...
Ms     <-read.csv('~/Work/MuridRodentTroughs/dataAnalysis/exons/Ms.castaneusDistance.csv')
...
pdf('Work/MuridRodentTroughs/Plots/exons_pi_genetic_castaneus.pdf', width =8.0, height = 5.5)
...
pdf('Work/MuridRodentTroughs/Plots/exons_piRef_genetic_castaneus.pdf', width =8.0, height = 5.5)
...
png('Work/MuridRodentTroughs/Plots/exons_piRef_genetic_castaneus.png', width =600, height = 400)
ggplot(data = Mm[Mm$dist>0,], aes(x= dist, y = pi_ref, col = lab))+
  geom_line(data = Mm[Mm$dist<0,], aes(x= abs(dist), y = pi_ref, col = lab), alpha = 0.75)+
  geom_line(alpha = 0.75)+
  scale_y_continuous(expression(pi/pi[Ref]))+
...
pdf('Work/MuridRodentTroughs/Plots/exons_divFam_genetic_castaneus.pdf', width =8.0, height = 5.5)
...
pdf('Work/MuridRodentTroughs/Plots/exons_divRat_genetic_castaneus.pdf', width =8.0, height = 5.5)
...
png('Work/TBooker.github.io/img/research/exons_divFam_genetic_castaneus.png', width =600, height = 400)
ggplot(data = Mm[Mm$dist>0,], aes(x= dist, y = pi_ref, col = lab))+
  geom_line(data = Mm[Mm$dist<0,], aes(x= abs(dist), y = pi_ref, col = lab), alpha = 0.75)+
  geom_line(alpha = 0.75)+
  scale_y_continuous(expression(pi/pi[Ref]))+
