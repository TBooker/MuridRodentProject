...
ggplot(data = Mm, aes(x= dist, y = pi, col = lab))+
  geom_line()+
#  geom_vline(aes(xintercept = 2.5), alpha=0.7, lty = 2, col = 'red')+
  scale_y_continuous(expression(italic(pi)), limits = c(0,0.015))+
...
pdf('Work/MuridRodentTroughs/Plots/CNEs_pi_genetic_cox.pdf', width =8.0, height = 5.5)
...
pdf('Work/MuridRodentTroughs/Plots/CNEs_piRef_genetic_cox.pdf', width =8.0, height = 5.5)
...
pdf('Work/MuridRodentTroughs/Plots/CNEs_divFam_genetic_cox.pdf', width =8.0, height = 5.5)
...
pdf('Work/MuridRodentTroughs/Plots/CNEs_divRat_genetic_cox.pdf', width =8.0, height = 5.5)
